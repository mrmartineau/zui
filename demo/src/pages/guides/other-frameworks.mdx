...
| `zui-button-accent-primary` | Primary colour (default) |
| `zui-button-accent-secondary` | Secondary colour |
| `zui-button-accent-destructive` | Destructive/danger colour |
...
const classes = computed(() => [
  ...
  `zui-button-accent-${props.accent}`,
