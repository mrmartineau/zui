...
<Demo
  html={`<button class="zui-button" onclick="document.getElementById('dialog-pos-central').showModal()">central</button>
...
>
  <button class="zui-button" onclick="document.getElementById('dialog-pos-central-demo').showModal()">central</button>
  <button class="zui-button" onclick="document.getElementById('dialog-pos-left-demo').showModal()">left</button>
  <button class="zui-button" onclick="document.getElementById('dialog-pos-right-demo').showModal()">right</button>
  <button class="zui-button" onclick="document.getElementById('dialog-pos-top-demo').showModal()">top</button>
  <button class="zui-button" onclick="document.getElementById('dialog-pos-bottom-demo').showModal()">bottom</button>

  <dialog id="dialog-pos-central-demo" class="zui-dialog zui-dialog-position-central" closedby="any">
    <div class="zui-dialog-header">
      <h2 class="zui-dialog-title">central</h2>
      <p class="zui-dialog-description">Anchored 60px from the top of the viewport.</p>
    </div>
  ...
  <dialog id="dialog-pos-left-demo" class="zui-dialog zui-dialog-position-left" closedby="any">
    <div class="zui-dialog-header">
      <h2 class="zui-dialog-title">left</h2>
      <p class="zui-dialog-description">Slides in from the left edge.</p>
    </div>
  ...
  <dialog id="dialog-pos-right-demo" class="zui-dialog zui-dialog-position-right" closedby="any">
    <div class="zui-dialog-header">
      <h2 class="zui-dialog-title">right</h2>
      <p class="zui-dialog-description">Slides in from the right edge.</p>
    </div>
  ...
  <dialog id="dialog-pos-top-demo" class="zui-dialog zui-dialog-position-top" closedby="any">
    <div class="zui-dialog-header">
      <h2 class="zui-dialog-title">top</h2>
      <p class="zui-dialog-description">Slides in from the top edge.</p>
    </div>
  ...
  <dialog id="dialog-pos-bottom-demo" class="zui-dialog zui-dialog-position-bottom" closedby="any">
    <div class="zui-dialog-header">
      <h2 class="zui-dialog-title">bottom</h2>
      <p class="zui-dialog-description">Slides in from the bottom edge.</p>
    </div>
