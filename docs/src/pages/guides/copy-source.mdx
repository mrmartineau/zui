...
1. **Framework** — React, Astro, or CSS only
...
The script detects your package manager (npm, pnpm, yarn, or bun) and installs `cva` automatically for React, Astro, Solid, and Vue workflows. CSS-only installs have no JavaScript dependencies.
