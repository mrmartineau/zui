...
ZUI ships first-party Vue 3 components (SFCs with `<script setup>`) that wrap the underlying CSS classes, giving you typed props and variant support out of the box.
