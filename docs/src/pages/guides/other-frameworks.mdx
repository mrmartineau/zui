...
ZUI ships first-party wrappers for [React](/guides/react), [Astro](/guides/astro), [Solid](/guides/solid), [Svelte](/guides/svelte), and [Vue](/guides/vue). For other frameworks, use the CSS classes directly.
