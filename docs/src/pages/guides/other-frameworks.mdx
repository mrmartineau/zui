...
ZUI is a CSS-first library. The React, Astro, Solid, and Vue components are thin wrappers around CSS classes, so ZUI works with **any** UI library or framework — Svelte, Angular, Web Components, or plain HTML.
