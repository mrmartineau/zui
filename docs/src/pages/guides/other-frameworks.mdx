...
ZUI ships first-party wrappers for [React](/guides/react), [Astro](/guides/astro), [Solid](/guides/solid), [Svelte](/guides/svelte), and [Vue](/guides/vue), plus framework-free [Web Components](/guides/web-components) that work anywhere real DOM is rendered. For everything else, use the CSS classes directly.
...
> **Tip:** ZUI already ships first-party wrappers for [React](/guides/react), [Astro](/guides/astro), [Solid](/guides/solid), [Svelte](/guides/svelte), and [Vue](/guides/vue).
